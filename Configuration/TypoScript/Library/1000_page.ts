...
page.10 {
    partialRootPath = EXT:typo3ruhr/Resources/Private/Partials/
    layoutRootPath = EXT:typo3ruhr/Resources/Private/Layouts/

    #file = EXT:typo3ruhr/Resources/Private/Templates/Homepage.html
    ...
    file.stdWrap.cObject {
        ...
        # default = 2Columns
        default = TEXT
        default.value = EXT:typo3ruhr/Resources/Private/Templates/2Columns.html
        ...
        # Homepage
        pagets__1 = TEXT
        pagets__1.value = EXT:typo3ruhr/Resources/Private/Templates/Homepage.html
        ...
        # 1Columns
        pagets__3 = TEXT
        pagets__3.value = EXT:typo3ruhr/Resources/Private/Templates/1Column.html
    }
...
page {
    ...
    # CSS
    includeCSS {
        file10 = EXT:typo3ruhr/Resources/Public/Css/bootstrap.min.css
        file10.disableCompression = 1
        file20 = EXT:typo3ruhr/Resources/Public/Css/bootstrap-theme.min.css
        file20.disableCompression = 1
        file30 = EXT:typo3ruhr/Resources/Public/Css/main.css
    }

    # JavaScript
    includeJS {
        modernizr = EXT:typo3ruhr/Resources/Public/JavaScript/modernizr-2.8.3-respond-1.4.2.min.js
        modernizr.disableCompression = 1
    }

    includeJSFooter {
        file10 = EXT:typo3ruhr/Resources/Public/JavaScript/bootstrap.min.js
        file10.disableCompression = 1
        file20 = EXT:typo3ruhr/Resources/Public/JavaScript/main.js
    }
...
<script>window.jQuery || document.write('<script src="typo3conf/ext/typo3ruhr/Resources/Public/JavaScript/jquery-1.11.2.min.js"><\/script>')</script>
)
